...
module.exports = class TestRailAPIs {
	...
	async getCases (projectID) {
		...
		const res = await axios({
			...
			throw Error('Provided projectId is not valid');
		});
	...
	async getCasesIDsByType (projectID, typeID) {
		...
		const res = await axios({
			...
			throw Error('Provided project ID or type ID is not valid');
		});
	...
	async addCase (sectionID, title = 'AutoCreatedTest', prioretyID = 2, typeID = 7) {
		...
		const res = await axios({
			...
			throw Error('Provided test ID or status Id is not valid');
		});
	...
	async deleteCase (caseID) {
		...
		const res = await axios({
			...
			throw Error('Provided case ID is not valid');
		});
	...
	async getMilestone (milestoneID) {
		...
		const res = await axios({
			...
			throw Error('Provided milestoneID is not valid');
		});
	...
	async getMilestones (projectID) {
		...
		const res = await axios({
			...
			throw Error('Provided project ID is not valid');
		});
	...
	async updateMilestone (milestoneID, isCompleted) {
		...
		const res = await axios({
			...
			throw Error('Provided milestone ID is not valid');
		});
	...
	async getPlan (planID) {
		...
		const res = await axios({
			...
			throw Error('Provided plan ID is not valid');
		});
	...
	async addConfig (configGroupID, name) {
		...
		const res = await axios({
			...
			throw Error('Provided configGroup ID is not valid');
		});
	...
	async updateConfig (configID, name) {
		...
		const res = await axios({
			...
			throw Error('Provided config ID is not valid');
		});
	...
	async getResults (testID) {
		...
		const res = await axios({
			...
			throw Error('Provided test ID is not valid');
		});
	...
	async getResultsForRun (runID) {
		...
		const res = await axios({
			...
			throw Error('Provided run ID is not valid');
		});
	...
	async getResultForCase (runID, caseID) {
		...
		const res = await axios({
			...
			throw Error('Provided run ID or case ID is not valid');
		});
	...
	async addResultForCase (runID, caseID, statusID, comment = '') {
		...
		const res = await axios({
			...
			throw Error('Provided run ID, case ID or status ID is not valid');
		});
	...
	async getSection (sectionID) {
		...
		const res = await axios({
			...
			throw Error('Provided section ID is not valid');
		});
	...
	async getSuite (suiteID) {
		...
		const res = await axios({
			...
			throw Error('Provided suite ID is not valid');
		});
	...
	async getUser (userID) {
		...
		const res = await axios({
			...
			throw Error('Provided user ID is not valid');
		});
	...
	async getUserByEmail (email) {
		...
		const res = await axios({
			...
			throw Error('Provided email is not valid');
		});
	...
	async addAttachmentToResult(resultId, imageFile) {
		...
		const res = axios({
			...
			throw Error(`Cannot attach file`);
		});
	...
	async getAttachment (attachmentID) {
		...
		const res = await axios({
			...
			throw Error('Provided attachmentID is not valid');
		});
	...
	async deleteAttachment (attachmentID) {
		...
		const res = await axios({
			...
			throw Error('Provided attachment ID is not valid');
		});
